 ...
 *
 * @author smlarson
 * Purpose:Exposing the private Map<String, IData> returnResults to the sub-class
 */
...
import static org.n52.wps.server.request.Request.SUPPORTED_VERSION;
...
public class ExecuteRequest extends Request implements IObserver {
	...
	protected Map<String, IData> returnResults; //#USGS#

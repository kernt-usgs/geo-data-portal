...
public class GDPAlgorithmUtilTest {
	...
	@Test
	public void testDataCubeSize() throws InvalidRangeException, TransformException, FactoryException {
		...
		assertThat(dataCubeSmall.getTotalSize(), is(equalTo(210l)));
		assertThat(dataCubeLarge.getTotalSize(), is(equalTo(3000000000l)));
		assertThat(dataCubeHuge.getTotalSize(), is(equalTo(4000000000l)));
	}
